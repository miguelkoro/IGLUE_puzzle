 ...
 return (
    <div className='remote' style={{
       ...
       // top: "80%",
        ...
        <div id="row5" className="row" style={{top: "62%", left: "50%"}}>
        ...
        <div id="row6" className="row" style={{top: "72%", left: "50%"}}>
